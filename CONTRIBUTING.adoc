...
Operational code is placed under the `src` folder.

Build output is generated under the `out` folder.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/judo-jsl-tmbundle/issues/new/choose[issue form].
